...
@:enum @:jsRequire("three") extern abstract CompressedPixelFormat(Int) from Int to Int {
	...
	final RGB_ETC2_Format : CompressedPixelFormat;
	final RGBA_ETC2_EAC_Format : CompressedPixelFormat;
	...
	final SRGB8_ALPHA8_ASTC_4x4_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_5x4_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_5x5_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_6x5_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_6x6_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_8x5_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_8x6_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_8x8_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_10x5_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_10x6_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_10x8_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_10x10_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_12x10_Format : CompressedPixelFormat;
	final SRGB8_ALPHA8_ASTC_12x12_Format : CompressedPixelFormat;
	final RGBA_BPTC_Format : CompressedPixelFormat;
}