...
@:jsRequire("three", "BufferGeometryLoader") extern class BufferGeometryLoader extends Loader {
	...
	function load(url:String, onLoad:(bufferGeometry:ts.AnyOf2<BufferGeometry, InstancedBufferGeometry>) -> Void, ?onProgress:(request:js.html.ProgressEvent_<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):Void;
	function loadAsync(url:String, ?onProgress:(event:js.html.ProgressEvent_<js.html.EventTarget>) -> Void):js.lib.Promise<ts.AnyOf2<BufferGeometry, InstancedBufferGeometry>>;
